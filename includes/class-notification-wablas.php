...
class WhatsappWablas extends Notifications\Notification_Base
{
    protected $id = 'lsdd_whatsapp_wablas';
    protected $name = 'Wablas';
...
*LSDDonasi*';
    ...
    protected $apikey;
    /**
     * Api Key for Credentials to Wablas
     */
    protected $server;
    ...
    public function templating( array $object )
    {
        if ($this->status()) {
            ...
            // Check Template
            if(empty($template)){
                $this->log( empty($phone) ? 'Not Set' : $phone, 'On ' . ucfirst($object['event']), __('Tolong atur template terlebih dahulu', 'lsddonation-wablas'));
                return;
            }
            
            // Checking Receiver
            if(empty($phone)){
                $this->log( empty($phone) ? 'Not Set' : $phone, 'On ' . ucfirst($object['event']), __('Donatur tidak menginput nomor telepon', 'lsddonation-wablas'));
                return;
            }
    ...
    public function manage()
    {
        ...
        <style>
            ...
            #tab-wablas-order:checked~.tab-body-wrapper #tab-body-wablas-order,
            #tab-wablas-completed:checked~.tab-body-wrapper #tab-body-wablas-completed,
            #tab-wablas-followup:checked~.tab-body-wrapper #tab-body-wablas-followup,
        ...
        <div class="tabs-wrapper">
            ...
            <label class="tab" for="tab-wablas-log"><?php _e('Log', 'lsddonation');?></label>

            <input type="radio" name="wablas" id="tab-wablas-order"/>
            <label class="tab" for="tab-wablas-order"><?php _e('Ketika Donasi', 'lsddonation');?></label>

            <input type="radio" name="wablas" id="tab-wablas-completed"/>
            <label class="tab" for="tab-wablas-completed"><?php _e('Ketika Selesai', 'lsddonation');?></label>
            <!--
            <input type="radio" name="wablas" id="tab-wablas-followup"/>
            <label class="tab" for="tab4"><?php //_e('On FollowUp', 'lsddonation');?></label> -->

            <input type="radio" name="wablas" id="tab-wablas-settings"/>
            <label class="tab" for="tab-wablas-settings"><?php _e('Settings', 'lsddonation');?></label>
            ...
            <div class="tab-body-wrapper">
                ...
                <div id="tab-body-wablas-log" class="tab-body">
                    ...
                    <a href="https://wablas.com/" target="_blank" style="margin-top:3px;margin-bottom:15px;background:#b21919;border:none;width:150px;border-radius:20px;" class="btn btn-primary input-group-btn"><?php _e('Daftar Wablas', "lsddonation");?></a>
                    ...
                    <div class="input-group" style="width:50%;">
                        ...
                        <button id="lsdd_wablas_test" style="margin-top:3px;" class="btn btn-primary input-group-btn"><?php _e('Test Notification', "lsddonation");?></button>
                    </div>

                    <br>

                    <div class="divider" data-content="Wablas Notification Log"></div>
                ...
                <!------------ Tab : On Order ------------>
                <div id="tab-body-wablas-order" class="tab-body">
                    ...
                    <div class="columns col-gapless">
                        ...
                        <div class="column col-3" style="padding:0 10px 0 0;">
                            ...
                            <br>
                            <button data-type="order" class="btn btn-primary input-group-btn lsdd_wablas_templates_save"><?php _e('Save', 'lsddonation');?></button>
                        </div>
                ...
                <!------------ Tab : On Completed ------------>
                <div id="tab-body-wablas-completed" class="tab-body">
                    ...
                    <div class="columns col-gapless">
                        ...
                        <div class="column col-3" style="padding:0 10px 0 0;">
                            ...
                            <button data-type="completed" class="btn btn-primary input-group-btn lsdd_wablas_templates_save"><?php _e('Save', 'lsddonation');?></button>
                        </div>
                        ...
                        <div class="column col-8" style="margin-left:35px;">
                            ...
                            <?php endif;?>
                            <!-- Migration Alert -->
                            <textarea data-event="completed" class="form-input lsdd_wablas_message_templates" placeholder="Pesan Notifikasi Untuk Donatur Ketika Pembayaran Berhasil" rows="14"><?php echo esc_attr($this->completed_message); ?></textarea>
                        </div>
                    </div>
                ...
                <!------------ Tab : FollowUp ------------>
                <div id="tab-body-wablas-followup" class="tab-body">
                    ...
                    <form class="form-horizontal" block="settings">
                        ...
                        <div class="form-group">
                            <div class="col-3 col-sm-12">
                                <label class="form-label" for="country"><?php _e('Server Wablas', "lsddonation");?></label>
                            </div>
        ...
        <script>
            ...
            jQuery(document).on("click",".lsdd_wablas_templates_save",function( e ) {
                ...
                jQuery.post( lsdd_admin.ajax_url, {
                    action  : 'lsdd_whatsapp_wablas_save',
                    type    : type,
                    content : content,
            ...
            jQuery(document).on("click","#lsdd_wablas_test",function( e ) {
                ...
                if( wablas_number != '' ){
                    ...
                    jQuery.post( lsdd_admin.ajax_url, {
                        action : 'lsdd_whatsapp_wablas_test',
                        phone  : wablas_number,
                        security : lsdd_admin.ajax_nonce,
                        }, function( response ){
...
Notifications\Registrar::register("whatsapp-wablas", new WhatsappWablas());
?>